(() => {
  ...
  function injectStyle() {
    ...
    style.textContent = `
      ...
      body.portal-shell #calendar .event-month-occurrence.fc-daygrid-block-event,
      body.portal-shell #calendar .event-month-span-single.fc-daygrid-block-event{
        border:0!important;
        color:#fff!important;
      ...
      body.portal-shell #calendar .fc-timegrid-event-harness .event-admin-block{
      ...
      @media (max-width:640px){
        ...
        body.portal-shell #calendar .fc-daygrid-day-events{padding-inline:2px!important;}
        body.portal-shell #calendar .fc-daygrid-event-harness{margin-bottom:1px!important;}
        body.portal-shell #calendar .fc-daygrid-event,
