(() => {
  ...
  function style() {
    ...
    css.textContent = `
      ...
      .admin-tab-header-tools .event-request-filters input,.admin-tab-header-tools .event-request-filters select{min-height:34px!important;border-radius:999px!important;background:#fff!important;box-shadow:0 8px 20px rgba(15,23,42,.06)!important;}
      ...
      #eventRequestsModal #eventRequestsList.event-request-detail-grid{display:flex!important;flex-direction:row!important;grid-template-rows:none!important;grid-auto-flow:unset!important;grid-auto-columns:unset!important;gap:16px!important;max-width:calc(100vw - 40px)!important;min-width:0!important;overflow-x:scroll!important;overflow-y:hidden!important;padding:4px 4px 24px!important;scroll-snap-type:x proximity!important;width:calc(100vw - 40px)!important;}
      ...
      @media(max-width:860px){
        ...
        #eventRequestsModal #eventRequestsList.event-request-detail-grid{flex-direction:column!important;min-width:0!important;overflow-x:hidden!important;overflow-y:auto!important;padding:2px 2px 20px!important;width:100%!important;}
