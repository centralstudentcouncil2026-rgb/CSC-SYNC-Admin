...
(() => {
  ...
  function style() {
    ...
    s.textContent = `
      ...
      body.portal-shell #calendar,body.admin-dashboard-shell #calendar,body.org-dashboard-shell #calendar{box-sizing:border-box!important;display:block!important;min-width:0!important;max-width:100%!important;width:100%!important;overflow:hidden!important;}
      ...
      body.org-dashboard-shell #calendar .fc,body.org-dashboard-shell #calendar .fc-view-harness,body.org-dashboard-shell #calendar .fc-view-harness-active,body.org-dashboard-shell #calendar .fc-scrollgrid{box-sizing:border-box!important;max-width:100%!important;min-width:0!important;width:100%!important;}
      body.portal-shell #calendar .fc-scrollgrid table,body.portal-shell #calendar .fc-col-header,body.portal-shell #calendar .fc-daygrid-body,body.portal-shell #calendar .fc-daygrid-body table,
      body.admin-dashboard-shell #calendar .fc-scrollgrid table,body.admin-dashboard-shell #calendar .fc-col-header,body.admin-dashboard-shell #calendar .fc-daygrid-body,body.admin-dashboard-shell #calendar .fc-daygrid-body table,
      body.org-dashboard-shell #calendar .fc-scrollgrid table,body.org-dashboard-shell #calendar .fc-col-header,body.org-dashboard-shell #calendar .fc-daygrid-body,body.org-dashboard-shell #calendar .fc-daygrid-body table{max-width:100%!important;width:100%!important;}
      body.portal-shell #calendar .fc-daygrid-day-frame,body.admin-dashboard-shell #calendar .fc-daygrid-day-frame,body.org-dashboard-shell #calendar .fc-daygrid-day-frame{min-height:clamp(66px,12dvh,128px)!important;}
