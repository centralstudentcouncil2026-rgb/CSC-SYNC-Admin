(() => {
  ...
  function injectToastStyle() { if (document.getElementById('toast-position-fix-style')) return; const style = document.createElement('style'); style.id = 'toast-position-fix-style'; style.textContent = `.toast-region{position:fixed!important;right:18px!important;bottom:18px!important;left:auto!important;top:auto!important;z-index:2147483647!important;display:flex!important;flex-direction:column!important;align-items:flex-end!important;gap:10px!important;max-width:min(420px,calc(100vw - 36px))!important;pointer-events:none!important}.toast{width:max-content!important;max-width:min(420px,calc(100vw - 36px))!important;pointer-events:auto!important;box-shadow:0 18px 42px rgba(15,23,42,.22)!important}@media(max-width:768px){.toast-region{left:50%!important;right:auto!important;top:50%!important;bottom:auto!important;align-items:center!important;width:min(360px,calc(100vw - 28px))!important;max-width:min(360px,calc(100vw - 28px))!important;transform:translate(-50%,-50%)!important}.toast{box-sizing:border-box!important;width:100%!important;max-width:100%!important;text-align:center!important;border-radius:14px!important;padding:13px 15px!important;font-size:clamp(.92rem,4vw,1rem)!important;line-height:1.35!important;overflow-wrap:anywhere!important}}`; document.head.appendChild(style); }
