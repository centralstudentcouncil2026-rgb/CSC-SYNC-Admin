...
(() => {
  ...
  function style() {
    ...
    s.textContent = `
      ...
      body.portal-shell .calendar-panel,body.admin-dashboard-shell .calendar-panel,body.org-dashboard-shell .calendar-panel{box-sizing:border-box!important;min-width:0!important;min-height:0!important;overflow:hidden!important;}
      body.portal-shell #calendar,body.admin-dashboard-shell #calendar,body.org-dashboard-shell #calendar{box-sizing:border-box!important;display:block!important;min-height:520px!important;min-width:0!important;max-width:100%!important;width:100%!important;overflow:hidden!important;}
      body.portal-shell #calendar .fc,body.portal-shell #calendar .fc-view-harness,body.portal-shell #calendar .fc-view-harness-active,body.portal-shell #calendar .fc-scrollgrid,
      body.admin-dashboard-shell #calendar .fc,body.admin-dashboard-shell #calendar .fc-view-harness,body.admin-dashboard-shell #calendar .fc-view-harness-active,body.admin-dashboard-shell #calendar .fc-scrollgrid,
      body.org-dashboard-shell #calendar .fc,body.org-dashboard-shell #calendar .fc-view-harness,body.org-dashboard-shell #calendar .fc-view-harness-active,body.org-dashboard-shell #calendar .fc-scrollgrid{box-sizing:border-box!important;height:100%!important;max-height:100%!important;max-width:100%!important;min-height:0!important;min-width:0!important;width:100%!important;}
      body.portal-shell #calendar .fc-scroller,body.admin-dashboard-shell #calendar .fc-scroller,body.org-dashboard-shell #calendar .fc-scroller{min-height:0!important;}
      body.portal-shell #calendar .fc-scrollgrid table,body.portal-shell #calendar .fc-col-header,body.portal-shell #calendar .fc-daygrid-body,body.portal-shell #calendar .fc-daygrid-body table,body.portal-shell #calendar .fc-scrollgrid-sync-table,
      body.admin-dashboard-shell #calendar .fc-scrollgrid table,body.admin-dashboard-shell #calendar .fc-col-header,body.admin-dashboard-shell #calendar .fc-daygrid-body,body.admin-dashboard-shell #calendar .fc-daygrid-body table,body.admin-dashboard-shell #calendar .fc-scrollgrid-sync-table,
      body.org-dashboard-shell #calendar .fc-scrollgrid table,body.org-dashboard-shell #calendar .fc-col-header,body.org-dashboard-shell #calendar .fc-daygrid-body,body.org-dashboard-shell #calendar .fc-daygrid-body table,body.org-dashboard-shell #calendar .fc-scrollgrid-sync-table{height:100%!important;max-width:100%!important;width:100%!important;}
      body.portal-shell #calendar .fc-daygrid-body tbody,body.portal-shell #calendar .fc-daygrid-body tr,body.portal-shell #calendar .fc-daygrid-day,
      body.admin-dashboard-shell #calendar .fc-daygrid-body tbody,body.admin-dashboard-shell #calendar .fc-daygrid-body tr,body.admin-dashboard-shell #calendar .fc-daygrid-day,
      body.org-dashboard-shell #calendar .fc-daygrid-body tbody,body.org-dashboard-shell #calendar .fc-daygrid-body tr,body.org-dashboard-shell #calendar .fc-daygrid-day{visibility:visible!important;opacity:1!important;}
      body.portal-shell #calendar .fc-daygrid-day-frame,body.admin-dashboard-shell #calendar .fc-daygrid-day-frame,body.org-dashboard-shell #calendar .fc-daygrid-day-frame{display:block!important;min-height:clamp(66px,12dvh,128px)!important;position:relative!important;visibility:visible!important;opacity:1!important;}
      body.portal-shell #calendar .fc-daygrid-day-number,body.admin-dashboard-shell #calendar .fc-daygrid-day-number,body.org-dashboard-shell #calendar .fc-daygrid-day-number{color:#0f172a!important;display:block!important;font-weight:800!important;opacity:1!important;position:relative!important;visibility:visible!important;z-index:2!important;}
      body.portal-shell #calendar .fc-day-other .fc-daygrid-day-number,body.admin-dashboard-shell #calendar .fc-day-other .fc-daygrid-day-number,body.org-dashboard-shell #calendar .fc-day-other .fc-daygrid-day-number{color:#94a3b8!important;}
      body.portal-shell #calendar .fc-day-today .fc-daygrid-day-frame,body.admin-dashboard-shell #calendar .fc-day-today .fc-daygrid-day-frame,body.org-dashboard-shell #calendar .fc-day-today .fc-daygrid-day-frame{background:rgba(254,240,138,.38)!important;}
      body.portal-shell #calendar .fc-scrollgrid td,body.portal-shell #calendar .fc-scrollgrid th,body.admin-dashboard-shell #calendar .fc-scrollgrid td,body.admin-dashboard-shell #calendar .fc-scrollgrid th,body.org-dashboard-shell #calendar .fc-scrollgrid td,body.org-dashboard-shell #calendar .fc-scrollgrid th{border-color:#cbd5e1!important;border-style:solid!important;}
      body.portal-shell #calendar .fc-event,body.portal-shell #calendar .fc-more-link,body.admin-dashboard-shell #calendar .fc-event,body.admin-dashboard-shell #calendar .fc-more-link,body.org-dashboard-shell #calendar .fc-event,body.org-dashboard-shell #calendar .fc-more-link{max-width:100%!important;overflow:hidden!important;text-overflow:ellipsis!important;}
      body.portal-shell #calendar .fc-event-title,body.portal-shell #calendar .fc-event-time,body.admin-dashboard-shell #calendar .fc-event-title,body.admin-dashboard-shell #calendar .fc-event-time,body.org-dashboard-shell #calendar .fc-event-title,body.org-dashboard-shell #calendar .fc-event-time{overflow:hidden!important;text-overflow:ellipsis!important;white-space:nowrap!important;}
      ...
      @media(max-width:720px){
        ...
        body.portal-shell #calendar,body.admin-dashboard-shell #calendar,body.org-dashboard-shell #calendar{height:min(720px,calc(100dvh - 170px))!important;min-height:520px!important;overflow:auto!important;-webkit-overflow-scrolling:touch!important;}
        body.portal-shell #calendar .fc-daygrid-day-frame,body.admin-dashboard-shell #calendar .fc-daygrid-day-frame,body.org-dashboard-shell #calendar .fc-daygrid-day-frame{min-height:72px!important;}
        body.portal-shell #calendar .fc-col-header-cell-cushion,body.admin-dashboard-shell #calendar .fc-col-header-cell-cushion,body.org-dashboard-shell #calendar .fc-col-header-cell-cushion{font-size:.72rem!important;padding:3px 1px!important;}
        body.portal-shell #calendar .fc-daygrid-day-number,body.admin-dashboard-shell #calendar .fc-daygrid-day-number,body.org-dashboard-shell #calendar .fc-daygrid-day-number{font-size:.74rem!important;padding:3px 4px!important;}
        body.portal-shell #calendar .fc-daygrid-event,body.portal-shell #calendar .fc-more-link,body.admin-dashboard-shell #calendar .fc-daygrid-event,body.admin-dashboard-shell #calendar .fc-more-link,body.org-dashboard-shell #calendar .fc-daygrid-event,body.org-dashboard-shell #calendar .fc-more-link{font-size:.68rem!important;line-height:1.12!important;margin-inline:1px!important;padding-inline:2px!important;}
      }
    `;
