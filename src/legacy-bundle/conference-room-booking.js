...
(() => {
  ...
  function style() {
    ...
    css.textContent = `
      ...
      #conferenceRoomModal .conference-room-header{box-sizing:border-box!important;display:grid!important;grid-template-columns:var(--csc-shared-control-size,40px) minmax(0,1fr) max-content!important;align-items:center!important;gap:var(--csc-shared-header-gap,clamp(6px,1vw,12px))!important;background:linear-gradient(135deg,#facc15 0%,#eab308 62%,#ca8a04 100%)!important;border-bottom:1px solid #2563eb!important;border-radius:0!important;margin:0!important;min-height:var(--csc-shared-header-height,58px)!important;max-width:100%!important;min-width:0!important;padding-block:clamp(6px,.9vw,10px)!important;padding-inline:var(--csc-shared-header-padding-x,clamp(8px,1.4vw,18px))!important;width:100%!important;}
      body.admin-tab-page-open:has(.conference-room-page.is-active){border-radius:0!important;overflow:hidden!important;}
      .conference-room-header h3{margin:0!important;font-size:var(--csc-shared-header-title,clamp(1rem,2.2vw,2rem))!important;line-height:1.05!important;min-width:0!important;overflow:hidden!important;text-align:center!important;text-overflow:ellipsis!important;white-space:nowrap!important;}
      .conference-room-tools{align-items:center!important;display:flex!important;flex:0 0 auto!important;gap:var(--csc-shared-header-gap,clamp(6px,1vw,12px))!important;justify-self:end!important;max-width:100%!important;min-width:max-content!important;}
      ...
      .conference-room-nav-button{align-items:center!important;aspect-ratio:1/1!important;background:rgba(255,255,255,.9)!important;border:1px solid rgba(100,116,139,.24)!important;border-radius:50%!important;box-shadow:0 8px 18px rgba(15,23,42,.08)!important;color:#071c3d!important;display:inline-flex!important;flex:0 0 var(--csc-shared-control-size,44px)!important;font-size:1.15rem!important;font-weight:900!important;height:var(--csc-shared-control-size,44px)!important;justify-content:center!important;line-height:1!important;max-width:var(--csc-shared-control-size,44px)!important;min-height:var(--csc-shared-control-size,44px)!important;min-width:var(--csc-shared-control-size,44px)!important;padding:0!important;width:var(--csc-shared-control-size,44px)!important;}
      ...
      .conference-room-notifications{height:var(--csc-shared-control-size,44px)!important;max-width:var(--csc-shared-control-size,44px)!important;min-height:var(--csc-shared-control-size,44px)!important;width:var(--csc-shared-control-size,44px)!important;min-width:var(--csc-shared-control-size,44px)!important;padding:0!important;}
      ...
      @media(max-width:720px){#conferenceRoomModal .conference-room-header{grid-template-columns:var(--csc-shared-control-size,40px) minmax(0,1fr) max-content!important;padding-block:clamp(6px,.9vw,10px)!important;padding-inline:var(--csc-shared-header-padding-x,clamp(6px,2vw,10px))!important;}#conferenceRoomModal .conference-room-header h3{font-size:var(--csc-shared-header-title,clamp(.9rem,4.2vw,1.15rem))!important;}.conference-room-tools{gap:var(--csc-shared-header-gap,clamp(4px,1.2vw,7px))!important;}.conference-room-tools .conference-room-nav-button,.conference-room-tools .conference-room-notifications{flex-basis:var(--csc-shared-control-size,36px)!important;height:var(--csc-shared-control-size,36px)!important;max-width:var(--csc-shared-control-size,36px)!important;min-height:var(--csc-shared-control-size,36px)!important;min-width:var(--csc-shared-control-size,36px)!important;padding:0!important;width:var(--csc-shared-control-size,36px)!important;}.conference-room-tools .conference-room-nav-button{font-size:1.05rem!important;}#conferenceRoomModal .conference-room-body{height:calc(100dvh - var(--csc-measured-header-height,var(--csc-shared-header-height,54px)))!important;padding:8px!important;}#conferenceRoomCalendar{height:calc(100dvh - var(--csc-measured-header-height,var(--csc-shared-header-height,54px)) - 16px)!important;max-height:calc(100dvh - var(--csc-measured-header-height,var(--csc-shared-header-height,54px)) - 16px)!important;min-height:300px!important;}#conferenceRoomCalendar .fc-timegrid-event .fc-event-main-frame{padding:2px 3px!important;}#conferenceRoomCalendar .fc-event-time,#conferenceRoomCalendar .fc-event-title{font-size:.58rem!important;line-height:1.03!important;}.conference-room-dialog .form-grid.two,.conference-room-detail-list{grid-template-columns:1fr;}.conference-room-details-dialog footer{grid-template-columns:1fr;}.conference-room-details-dialog footer span{display:none;}}
    `;
