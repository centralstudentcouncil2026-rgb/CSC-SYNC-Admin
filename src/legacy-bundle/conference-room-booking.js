...
(() => {
  ...
  function ensureUi() {
    ...
    const reference = document.getElementById('eventRequestsButton') || document.getElementById('announcementsButton');
  ...
  function style() {
    ...
    css.textContent = `
      ...
      #conferenceRoomModal .conference-room-card{box-sizing:border-box!important;display:grid!important;grid-template-rows:auto minmax(0,1fr)!important;height:100dvh!important;max-height:none!important;max-width:none!important;min-height:100dvh!important;min-width:0!important;width:100%!important;margin:0!important;padding:0!important;border:0!important;border-radius:0!important;box-shadow:none!important;overflow:hidden!important;}
      #conferenceRoomModal .conference-room-header{box-sizing:border-box!important;display:grid!important;grid-template-columns:var(--csc-shared-control-size,40px) minmax(0,1fr) max-content!important;align-items:center!important;gap:var(--csc-shared-header-gap,clamp(5px,.7vw,8px))!important;background:linear-gradient(135deg,#facc15 0%,#eab308 62%,#ca8a04 100%)!important;border-bottom:1px solid #2563eb!important;border-radius:0!important;margin:0!important;min-height:var(--csc-shared-header-height,52px)!important;max-width:100%!important;min-width:0!important;padding-block:clamp(4px,.6vw,6px)!important;padding-inline:var(--csc-shared-header-padding-x,clamp(6px,1vw,14px))!important;width:100%!important;}
      body.admin-tab-page-open:has(.conference-room-page.is-active){border-radius:0!important;overflow:hidden!important;}
      #conferenceRoomModal .conference-room-header>div:not(.conference-room-tools){display:flex!important;justify-content:center!important;min-width:0!important;overflow:hidden!important;}
      .conference-room-header h3{margin:0!important;font-size:var(--csc-shared-header-title,clamp(.95rem,1.65vw,1.35rem))!important;line-height:1.05!important;min-width:0!important;overflow:hidden!important;text-align:center!important;text-overflow:ellipsis!important;white-space:nowrap!important;width:100%!important;}
      .conference-room-tools{align-items:center!important;display:flex!important;flex:0 0 auto!important;gap:var(--csc-shared-header-gap,clamp(5px,.7vw,8px))!important;justify-self:end!important;max-width:100%!important;min-width:max-content!important;}
      .conference-room-tools button,.conference-room-header .portal-tab-back{min-height:var(--csc-shared-control-size,40px)!important;border-radius:999px!important;}
      .conference-room-nav-button{align-items:center!important;aspect-ratio:1/1!important;background:rgba(255,255,255,.9)!important;border:1px solid rgba(100,116,139,.24)!important;border-radius:50%!important;box-shadow:0 8px 18px rgba(15,23,42,.08)!important;color:#071c3d!important;display:inline-flex!important;flex:0 0 var(--csc-shared-control-size,40px)!important;font-size:clamp(.95rem,2.2vw,1.1rem)!important;font-weight:900!important;height:var(--csc-shared-control-size,40px)!important;justify-content:center!important;line-height:1!important;max-width:var(--csc-shared-control-size,40px)!important;min-height:var(--csc-shared-control-size,40px)!important;min-width:var(--csc-shared-control-size,40px)!important;padding:0!important;width:var(--csc-shared-control-size,40px)!important;}
      ...
      .conference-room-notifications{height:var(--csc-shared-control-size,40px)!important;max-width:var(--csc-shared-control-size,40px)!important;min-height:var(--csc-shared-control-size,40px)!important;width:var(--csc-shared-control-size,40px)!important;min-width:var(--csc-shared-control-size,40px)!important;padding:0!important;}
      .conference-room-header #conferenceRoomBack{align-items:center!important;color:#0f172a!important;display:inline-flex!important;font-family:Arial,Helvetica,sans-serif!important;font-size:0!important;font-weight:900!important;height:var(--csc-shared-control-size,40px)!important;justify-content:center!important;line-height:1!important;min-height:var(--csc-shared-control-size,40px)!important;min-width:var(--csc-shared-control-size,40px)!important;overflow:hidden!important;padding:0!important;text-indent:0!important;width:var(--csc-shared-control-size,40px)!important;}
      .conference-room-header #conferenceRoomBack::before{content:none!important;display:none!important;}
      .conference-room-header #conferenceRoomBack::after{color:#0f172a!important;content:'\\2190'!important;display:block!important;font-family:Arial,Helvetica,sans-serif!important;font-size:clamp(1rem,2.4vw,1.2rem)!important;font-weight:900!important;line-height:1!important;text-indent:0!important;}
      #conferenceRoomModal .conference-room-body{box-sizing:border-box!important;height:calc(100dvh - var(--csc-measured-header-height,var(--csc-shared-header-height,58px)))!important;min-height:0!important;overflow:hidden!important;padding:10px!important;background:#f8fafc!important;width:100%!important;}
      #conferenceRoomCalendar{box-sizing:border-box!important;display:block!important;height:calc(100dvh - var(--csc-measured-header-height,var(--csc-shared-header-height,58px)) - 20px)!important;min-height:320px!important;max-height:calc(100dvh - var(--csc-measured-header-height,var(--csc-shared-header-height,58px)) - 20px)!important;max-width:none!important;width:100%!important;background:#fff!important;border:1px solid #dbe4ef!important;border-radius:14px!important;overflow:hidden!important;}
      ...
      #conferenceRoomCalendar .fc-timegrid-slot{height:calc(var(--calendar-row-height,52px) / 2)!important;}
      #conferenceRoomCalendar .fc-timegrid-event{max-width:100%!important;overflow:hidden!important;}
      #conferenceRoomCalendar .fc-timegrid-event .fc-event-main-frame{box-sizing:border-box!important;display:block!important;height:100%!important;overflow:hidden!important;padding:3px 4px!important;}
      #conferenceRoomCalendar .fc-event-time,#conferenceRoomCalendar .fc-event-title{display:block!important;font-size:.68rem!important;font-weight:900!important;line-height:1.06!important;overflow:hidden!important;text-overflow:clip!important;white-space:normal!important;word-break:normal!important;overflow-wrap:normal!important;hyphens:none!important;}
      #conferenceRoomCalendar .fc-event-title{max-height:calc(100% - 1.05rem)!important;}
      ...
      @media(max-width:900px){#conferenceRoomCalendar .fc-col-header-cell-cushion{font-size:.76rem!important;padding:4px 1px!important;}#conferenceRoomCalendar .fc-timegrid-slot-label,#conferenceRoomCalendar .fc-event-time,#conferenceRoomCalendar .fc-event-title{font-size:.66rem!important;line-height:1.08!important;}}
      @media(max-width:720px){#conferenceRoomModal .conference-room-header{grid-template-columns:var(--csc-shared-control-size,36px) minmax(0,1fr) max-content!important;padding-block:clamp(4px,.6vw,6px)!important;padding-inline:var(--csc-shared-header-padding-x,clamp(5px,1.8vw,8px))!important;}#conferenceRoomModal .conference-room-header h3{font-size:var(--csc-shared-header-title,clamp(.85rem,4vw,1.05rem))!important;}.conference-room-tools{gap:var(--csc-shared-header-gap,clamp(3px,1vw,6px))!important;}.conference-room-tools .conference-room-nav-button,.conference-room-tools .conference-room-notifications{flex-basis:var(--csc-shared-control-size,36px)!important;height:var(--csc-shared-control-size,36px)!important;max-width:var(--csc-shared-control-size,36px)!important;min-height:var(--csc-shared-control-size,36px)!important;min-width:var(--csc-shared-control-size,36px)!important;padding:0!important;width:var(--csc-shared-control-size,36px)!important;}.conference-room-tools .conference-room-nav-button{font-size:1rem!important;}#conferenceRoomModal .conference-room-body{height:calc(100dvh - var(--csc-measured-header-height,var(--csc-shared-header-height,50px)))!important;padding:8px!important;}#conferenceRoomCalendar{height:calc(100dvh - var(--csc-measured-header-height,var(--csc-shared-header-height,50px)) - 16px)!important;max-height:calc(100dvh - var(--csc-measured-header-height,var(--csc-shared-header-height,50px)) - 16px)!important;min-height:300px!important;}#conferenceRoomCalendar .fc-timegrid-event .fc-event-main-frame{padding:2px 3px!important;}#conferenceRoomCalendar .fc-event-time,#conferenceRoomCalendar .fc-event-title{font-size:.58rem!important;line-height:1.03!important;}.conference-room-dialog .form-grid.two,.conference-room-detail-list{grid-template-columns:1fr;}.conference-room-details-dialog footer{grid-template-columns:1fr;}.conference-room-details-dialog footer span{display:none;}}
    `;
  ...
  function openPage() {
    ...
    try { sessionStorage.setItem('csc_active_dashboard_tab_admin', BUTTON_ID); } catch {}
  ...
  function initCalendar() {
    ...
    window.__conferenceRoomCalendar = calendar;
    calendar.render();
