...
async function startDashboard(store) {
  ...
  await import('./calendar-logic-guard.js?v=20260625-start-end-dates-v6');await import('./portal-logic-fixes.js?v=20260625-org-announcements-v1');await waitForFullCalendar();await import('./script.js?v=20260625-org-announcements-v1');await import('./portal-wiring.js?v=20260625-concerns-sync-v1');await import('./activity-status-bridge.js?v=20260625-profile-status-v3');await import('./ui-light-cards.js?v=20260625-org-announcements-v1');await import('./portal-ui-polish.js?v=20260625-org-announcements-v1');await import('./event-request-enhanced-cards.js?v=20260625-org-announcements-v1');await import('./admin-tabs-inline.js?v=20260625-org-announcements-v1');await import('./conference-room-booking.js?v=20260812-conference-room-db-v4');await import('./responsive-system.js?v=20260908-responsive-system-v2')
}
